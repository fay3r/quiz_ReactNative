...
const getDB = () =>
  DB
    ? DB
    : (DB = SQLite.openDatabase({name: 'testbase.db', createFromLocation: 1}));
            ...
            ListFooterComponent={
              <View
                ...
                <Text style={styles.footerText}>
                  {'Poznaj swoja pozycje w rankingu'}
                </Text>
                <View
                  style={[
                    {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={[{width: '100%', paddingLeft: 50, alignItems: 'center'}]}>
      ...
      <View style={styles.content}>
        {lastquestion > qnumber
          ? RenderQuestion(navigation, testContent, qnumber)
          : RenderFinalScore(
              navigation,
              testContent.name,
              testContent.tasks.length,
            )}
      </View>
    </SafeAreaView>
  );
    ...
    <View style={[{flex: 1}]}>
      <View
        ...
        <Text style={[{flex: 1, marginStart: 30}]}>
          Question {qnumber + 1} of {testContent.tasks.length}
        </Text>
      ...
      <View
        style={[
          {flex: 4, justifyContent: 'center', marginStart: 40, marginEnd: 70},
        ]}>
        <Text style={[{alignSelf: 'center'}, styles.opensansb]}>
          {testContent.tasks[qnumber].question}
        </Text>
      </View>
      <View style={{flex: 9}}>
          ...
          <View style={[{flexDirection: 'row', justifyContent: 'center'}]}>
            ...
            <TouchableOpacity
              style={[
                styles.centerMode,
                styles.border,
                {width: 70, backgroundColor: '#999999'},
              ]}>
            ...
            <TouchableOpacity
              style={[
                styles.centerMode,
                styles.border,
                {width: 100, backgroundColor: '#999999'},
              ]}>
  ...
  const renderItem = ({item}) => (
    <View style={[{flex: 1}]}>
      <View style={{flexDirection: 'row'}}>
        ...
        <Text style={[styles.border, {width: 70}]}>
      ...
      <DrawerContentScrollView>
        <View style={[]}>
          <View style={[{flex: 1, alignItems: 'center'}]}>
            ...
            />
            <Text style={[{marginTop: 10, fontSize: 22}, styles.langar]}>
              Quizowanko
            </Text>
          </View>
          <View style={{alignItems: 'flex-start', marginLeft: 15}}>
            <TouchableOpacity
              ...
              <Text style={styles.opensansitalic}>Strona Glowna</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[{marginTop: 10, padding: 5}]}
              onPress={() => {
              ...
              <Text style={styles.opensansitalic}>Ranking</Text>
            </TouchableOpacity>
            ...
            {netStatus == true
              ? allTestsData.map((el) => (
                  <TouchableOpacity
                    ...
                    <Text
                      style={[styles.opensansitalic, {textAlign: 'center'}]}>
                      {el.name}
                    </Text>
                  </TouchableOpacity>
                ))
    ...
    return (
      <NavigationContainer>
        <Drawer.Navigator
          ...
          drawerContent={(props) => <OwnDrawer {...props} />}>
